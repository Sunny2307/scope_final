...
const GuideReportGenerationPage = () => {
  ...
  const generateReport = async () => {
    ...
    try {
      ...
      const response = await axios.get('http://localhost:3000/api/auth/guide/monthly-report', {
        params: {
          year: selectedYear,
          month: selectedMonth,
        },
  ...
  const downloadPDF = async () => {
    ...
    doc.setFontSize(14);
    doc.setFont('helvetica', 'bold');
    doc.text('Monthly Scholarship Report (Guide)', pageWidth / 2, 22, { align: 'center' });
    ...
    // Save PDF
    const fileName = `Guide_Monthly_Report_${monthNames[selectedMonth - 1]}_${selectedYear}.pdf`;
    doc.save(fileName);
  };
    ...
    <div className="h-full bg-gray-50 p-6 overflow-y-auto">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-6 text-center">
          ...
          <p className="text-gray-600">Generate monthly reports for your students' scholarships and leaves</p>
        </div>
...
export default GuideReportGenerationPage;
