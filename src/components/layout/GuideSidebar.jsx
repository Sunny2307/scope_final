// src/components/layout/GuideSidebar.jsx

import React from 'react';
import { FiHome, FiMenu, FiUsers, FiUpload, FiFileText } from 'react-icons/fi';
import { Link } from 'react-router-dom';

const GuideSidebar = ({ isSidebarOpen, onSidebarToggle, activeItem }) => {
    const navItems = [
        { name: 'Home', icon: FiHome, path: '/guide/dashboard' },
        { name: 'Batch Info', icon: FiUsers, path: '/guide/batch-info' },
        { name: 'Report Generation', icon: FiFileText, path: '/guide/report-generation' },
    ];
