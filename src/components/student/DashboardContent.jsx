            ...
            <div className="flex flex-1 overflow-y-auto relative">
                ...
                <main className="flex-1 p-4 md:p-6 overflow-y-auto bg-gray-50">
                    <div className="flex justify-between items-center mb-6">
                        <div>
                            <h2 className="text-2xl font-bold text-gray-800 tracking-tight">Welcome, {user?.name || 'Student'}{user?.studentId ? ` - ${user.studentId}` : ''}</h2>
                        </div>
                    ...
                    {/* Conditionally render scholarship section only if student has scholarship */}
                    {scholarshipData.currentMonth.baseAmount > 0 ? (
                        ...
                        <div className="grid grid-cols-1 gap-6 items-stretch">
                            <div className="bg-white p-6 rounded-xl border border-gray-200 flex flex-col h-full min-h-[340px]">
                                <div className="flex justify-between items-center mb-4 relative">
                                    <h3 className="text-lg font-bold text-gray-800">Leave Status</h3>
                                    <button
                                        onClick={(e) => {
