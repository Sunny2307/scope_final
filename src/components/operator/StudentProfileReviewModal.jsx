      ...
      if (type === 'select') {
        ...
        return (
          <div className="relative">
            <button
              ...
              className={`w-full px-3 py-2 border rounded-lg text-left flex justify-between items-center bg-white text-gray-900 ${hasError ? 'border-red-500' : 'border-gray-300'
        ...
        return (
          <textarea
            ...
            rows="3"
            className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-gray-900 bg-white ${hasError ? 'border-red-500' : 'border-gray-300'
              }`}
          />
        );
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      {renderField('Department', editedData.department, 'department', 'text', [], false, true)}
                    </div>
                    <div>
              ...
              <div className="max-w-2xl mx-auto">
                ...
                <div className="flex justify-center gap-4">
                  <button
                    ...
                    className={`flex items-center gap-2 px-6 py-3 font-semibold rounded-lg shadow-sm transition-colors ${actionType === 'APPROVED'
